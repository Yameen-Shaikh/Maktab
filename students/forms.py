...
class StudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = ['name', 'phone_number1', 'phone_number2', 'student_class', 'address', 'amount', 'paid_till_date', 'fees_period']
        widgets = {
...
class SearchForm(forms.Form):
    query = forms.CharField(label='Search by Name or Roll Number', max_length=100)
